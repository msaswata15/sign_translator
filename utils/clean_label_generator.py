...
# Paths
labels_csv_path = "data/validation.csv"  # replace with your actual path
processed_data_dir = "data/processed/Validation"  # directory containing processed files
output_csv_path = "data/validation.csv"  # can overwrite labels_csv_path if you want
